...
class Value {
 public:
  ...
  void AssignValueFromKeyIfAvailable(std::string const& key, std::string &value) const;
  void AssignValueFromKeyIfAvailable(std::string const& key, int64_t &value) const;
